...
export default {
  ...
  jobTypes: {
    ...
    RESEND_VERIFICATION_EMAIL: 'RESEND VERIFICATION_EMAIL',
    SEND_API_KEY_REQUEST_EMAIL: 'SEND_API_KEY_REQUEST_EMAIL',
    SAVE_API_KEY_HISTORY: 'SAVE_API_KEY_HISTORY',
    SEND_AUTHENTICATION_SMS: 'SEND_AUTHENTICATION_SMS'
  },
  events: {
    SEND_VERIFICATION_EMAIL: 'SEND_VERIFICATION_EMAIL',
    SEND_INVITATION_EMAIL: 'SEND_INVITATION_EMAIL',
